    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_right">
                <form method="GET" action="{{ route('dashboard.beverages') }}" class="col-md-5 col-sm-5 form-group pull-right top_search">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        @endif
                        <form id="demo-form2" action="{{ route('dashboard.storebeverage') }}" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <button class="btn btn-primary" type="button" onclick="window.location='{{ route('dashboard.beverages') }}'">Cancel</button>
