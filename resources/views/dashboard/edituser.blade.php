					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" method="POST" action="{{ route('dashboard.updateuser', $user->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                      @csrf
                      @method('put')
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="fullname" name="fullname" value="{{ $user->fullname }}" required="required" class="form-control ">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="checkbox">
                          <label>
                          <input type="checkbox" name="active" class="flat" {{  old('active', $user->active)  ? 'checked' : '' }}>
                          </label>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          <a href="{{ route('dashboard.users') }}" class="btn btn-primary">Cancel</a>
